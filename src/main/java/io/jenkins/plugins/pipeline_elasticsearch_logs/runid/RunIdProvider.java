 ...
 * While in a classical Jenkins with UI it this can be achieved with full project name, build number and instance id, there might be use
 * cases when working with JenkinsFileRunner,

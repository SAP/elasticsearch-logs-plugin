...
public class ResourceUtils {
    ...
    /**
     * Returns the content of the {@code <testMethod>.Jenkinsfile} corresponding to
     * the test method which (indirectly) called this method.
     *
     * @return
     * @throws IOException
    ...
    /**
     * Returns the content of the {@code <testMethod>.log} file corresponding to the
     * test method which (indirectly) called this method.
     *
     * @return
     * @throws IOException
     * @throws SecurityException
    ...
    /**
     * Returns the content of the {@code <testMethod>.log.json} file corresponding
     * to the test method which (indirectly) called this method.
     *
    ...
    /**
     * Returns the resource path of the file, corresponding to the test method which
     * (indirectly) calls this method, with the specified fileExtension.
     *
     * @param fileExtension
     * @return
     * @throws SecurityException
    ...
    private static String getTestResourcePath(String fileExtension) throws SecurityException, ClassNotFoundException {
        ...
        return String.format("%s/%s.%s", method.getDeclaringClass().getName().replace(".", "/"),
                method.getName().replace(".", "/"), fileExtension);
    }

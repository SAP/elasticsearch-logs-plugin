...
/**
 * This test does not test productive code.
 * It only tests the JSONUtils used by other tests.
 */
public class JSONUtilsTest {
    ...
    public void testPrettyPrintDefinedOrder() {
        String before = "{" + "\"predecessors\":1," + "\"displayName\":1," + "\"an_undefined_key\":1," + "\"eventType\":1,"
                + "\"flowNodeId\":1" + "}";
        String after = prettyPrint(before);
        String expected = "{\n" + "  \"eventType\": 1,\n" + "  \"flowNodeId\": 1,\n" + "  \"predecessors\": 1,\n"
                + "  \"displayName\": 1,\n" + "  \"an_undefined_key\": 1\n" + "}";

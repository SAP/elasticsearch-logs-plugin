...
/**
 * This class mocks an ElasticSearchAccess and overrides the
 * {@link ElasticSearchAccess#push(String)} method. The data the plugin tries to
 * send to Elasticsearch are collected and can be retrieved via
 * {@link #getEntries()}.
 */
